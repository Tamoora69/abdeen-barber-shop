...
export default function Home() {
  ...
  const services = [
    ...
    { 
      name: "حلاقه + دقن + استشوار", 
      price: 150, 
      duration: 40, 
      description: "Haircut + modern styling + Beard complete grooming",
      icon: "✨"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          {/* Animated Title with Scissors - FIXED */}
          <div className="relative">
            {/* Top scissors - centered above title */}
            <div className="absolute -top-6 left-1/2 -translate-x-1/2">
              <div className={`text-5xl transition-all duration-1000 ${scissorRotate ? 'rotate-45' : 'rotate-0'}`}>
                ✂️
              </div>
            </div>
            ...
            {/* Bottom scissors - centered below title */}
          ...
          <p className="text-xl md:text-2xl text-gray-300 mt-12 mb-10 max-w-2xl mx-auto">
